...
<head>
    ...
    <link rel="stylesheet" href="assets/css/contact_confirm.css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body style="padding-top: 106.672px;">
    ...
    <main class="contact_confirm">
        <section class="section">
            <div class="row">
                <div class="col-12">
                    <h1 class="mgb_30 txt_center"><a href="/" title="contact confrim" class="confirm_title">送信完了</a>
                    </h1>
                    <div class="container txt_center">
                        ...
                        <p class="btn_confirm"><a href="index.php" title="戻 る">戻 る</a></p>
                    </div>
                </div>
            </div>
        </section>
