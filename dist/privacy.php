                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-12">
                            <p class="mgt_0">本ウェブサイトは、沖縄県人材育成事業協同組合（以下「当組合」）の事業内容等を紹介するサイトです。</p>
                            <h3>個人情報保護方針</h3>
                            <p>当組合は、以下のとおり個人情報保護方針を定め、個人情報保護の仕組みを構築し、全従業員に個人情報保護の重要性の認識と取組みを徹底させることにより、個人情報の保護を推進致します。</p>
                            <h3>個人情報の管理</h3>
                            <p>当組合は、お客さまの個人情報を正確かつ最新の状態に保ち、個人情報への不正アクセス・紛失・破損・改ざん・漏洩などを防止するため、セキュリティシステムの維持・管理体制の整備・社員教育の徹底等の必要な措置を講じ、安全対策を実施し個人情報の厳重な管理を行ないます。</p>
                            <h3>個人情報の利用目的</h3>
                            ...
                            <h3>個人情報の第三者への開示提供の禁止 </h3>
                            <p>当組合は、お客さまよりお預かりした個人情報を適切に管理し、次のいずれかに該当する場合を除き、個人情報を第三者に開示いたしません。</p>
                            <ul class="ul_text mg_0 p_0">•&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;お客さまの同意がある場合</ul>
                            <ul class="ul_text mg_0 p_0">•&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;お客さまが希望されるサービスを行なうために当社が業務を委託する業者に対して開示する場合</ul>
                            <ul class="ul_text mg_0 p_0">•&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法令に基づき開示することが必要である場合 </ul>
                            <h3>個人情報の安全対策</h3>
                            ...
                            <h3>お問い合わせ</h3>
                            <p>当組合の個人情報の取扱に関するお問い合わせは下記までご連絡ください。<br>
                                沖縄県人材育成事業協同組合<br>
                                〒900-0036<br>
                                沖縄県那覇市西2丁目12番14<br>
                                TEL：098-865-3377<br>
                                FAX：098-865-3355</p>
                            <p class="p_privacy mgt_20 mg_0">お問い合わせは<span class="sp_text">こちら</span>から</p>
                        </div>
                    </div>
                </div>
            </section>
